...
```typescript
import { cfaGetFacebookCurrentToken, AccessToken } from 'capacitor-firebase-auth';

//[...]

cfaGetFacebookCurrentToken().subscribe((r: AccessToken) => /* current Facebook Access Token */)
```
